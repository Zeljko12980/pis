...
/* Created on:     23/11/2021 14:22:28                          */
/*==============================================================*/
...
drop index "Sadrzi_usluge_FK";

drop index "Sadrzi_usluge2_FK";
...
/*==============================================================*/
create index "Sadrzi_usluge2_FK" on "Aranzman_Sadrzi_usluge" (
   "id_aranzman" ASC
);
...
/*==============================================================*/
create index "Sadrzi_usluge_FK" on "Aranzman_Sadrzi_usluge" (
